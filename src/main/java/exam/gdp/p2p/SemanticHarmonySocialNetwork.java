 ...
 * governing permissions and limitations under the License. A social Network
 * based on the users interests. The systems collects the profiles of the users,
 * and automatically creates friendships. The users can see its friends over the
 * time.
 */
